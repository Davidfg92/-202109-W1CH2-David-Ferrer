...
function calculadora() {
  ...
  let segundo = parseFloat(
    prompt(`Escriba el segundo número de la operación.`)
  );
  ...
  totalSum = `El resultado de la suma de ${primero} y ${segundo} es ${suma(
    primero,
    segundo
  )}`;
  totalRest = `El resultado de la resta de ${primero} y ${segundo} es ${resta(
    primero,
    segundo
  )}`;
  totalMult = `El resultado de la multiplicación de ${primero} y ${segundo} es ${multiplicacion(
    primero,
    segundo
  )}`;
  totalDiv = `El resultado de la división de ${primero} y ${segundo} es ${division(
    primero,
    segundo
  )}`;
